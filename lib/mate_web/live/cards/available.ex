        ...
        <ul class="list-group">
          <%= for balance <- @balances do %>
            ...
            <div class="row">
              ...
              <div id="amount_<%= @id %>" class="col-4 d-flex justify-content-end align-items-center" data-amount="<%= balance.amount %>" data-prev-amount="<%= balance.prev_amount %>" phx-hook="Odometer">
                <sup>Ars</sup>
              </div>
